...
export default [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('~/pages/document-drafting/index.vue'),
        meta: {
          title: '文书起草'
        }
      },
      {
        ...
        component: () => import('~/pages/contract-review/index.vue'),
        meta: {
          title: '合同审查'
        }
      },
      {
        path: '/elemental-conversion',
        name: 'ElementalConversionIndex',
        component: () => import('~/pages/elemental-conversion/index.vue'),
        meta: {
          title: '要素式转换'
        }
      },
      {
        ...
        component: () => import('~/pages/case-search/index.vue'),
        meta: {
          title: '案例检索'
        }
      },
      {
        path: '/legal-regulatory-search',
        name: 'LegalRegulatorySearchIndex',
        component: () => import('~/pages/legal-regulatory-search/index.vue'),
        meta: {
          title: '法律法规检索'
        }
      },
      {
        ...
        component: () => import('~/pages/contract-search/index.vue'),
        meta: {
          title: '合同检索'
        }
      },
        ...
        children: [
          {
            path: 'create', // 相对路径
            name: 'AgentCreate',
            component: () => import('~/pages/agent/create.vue'),
            meta: {
              title: '创建项目'
            }
          }
      ...
      },
      {
        path: '/my-team',
        name: 'MyTeamIndex',
        component: () => import('~/pages/my-team/index.vue'),
        meta: {
          title: '我的团队'
        }
      }
