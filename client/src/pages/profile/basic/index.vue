    ...
    <a-card :bordered="false">
      <a-descriptions :title="t('profile.basic.orderDetailTitle')">
        ...
        <a-descriptions-item :label="t('profile.basic.orderStatus')">
          {{ t('profile.basic.orderStatusValue') }}
          <!-- You will need to provide the translation for "已完成" -->
        </a-descriptions-item>
      ...
      <a-descriptions :title="t('profile.basic.customerInfoTitle')">
        <a-descriptions-item :label="t('profile.basic.customerName')"> 张三 </a-descriptions-item>
        ...
        <a-descriptions-item :label="t('profile.basic.remarks')"> 无特殊要求 </a-descriptions-item>
      </a-descriptions>
      <a-divider style="margin-bottom: 32px" />
      <a-descriptions :title="t('profile.basic.productInfoTitle')">
        <a-descriptions-item :label="t('profile.basic.productName')"> 商品A </a-descriptions-item>
        <a-descriptions-item :label="t('profile.basic.unitPrice')"> $50.00 </a-descriptions-item>
        <a-descriptions-item :label="t('profile.basic.quantity')"> 3 </a-descriptions-item>
        <a-descriptions-item :label="t('profile.basic.subtotal')"> $150.00 </a-descriptions-item>
      </a-descriptions>
      <a-divider style="margin-bottom: 32px" />
