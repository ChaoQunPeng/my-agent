 ...
 * @LastEditTime: 2025-10-17 14:31:01
 * @FilePath: /fadu-ai/src/layouts/basic-layout/index.vue
      ...
      <a-layout class="h-screen">
        <template v-if="header">
          <Header>
            ...
            <template
              v-if="slots.headerContent || layout === 'top' || layout === 'mix'"
              #headerContent
            >
        ...
        <a-layout-content flex flex-col>
