  ...
  <div class="login-container">
    ...
    <div class="login-content flex-center">
      <div class="ant-pro-form-login-main rounded">
        <!-- 登录头部 -->
        <!-- <div class="flex-between h-15 px-4 bg-white">
          <div class="flex-end">
...
<a-divider m-0 /> -->
        ...
        <div class="box-border flex min-h-[520px]">
          <!-- 登录框左侧 -->
          <div class="ant-pro-form-login-main-left min-h-[520px] flex-center bg-white">
            <img src="@/assets/images/login-banner.png" class="w-full h-full" />
          </div>
          <!-- <a-divider m-0 type="vertical" class="ant-pro-login-divider min-h-[520px]" /> -->
          <!-- 登录框右侧 -->
          <div
            class="ant-pro-form-login-main-right px-28 w-[335px] flex items-center flex-col relative z-11 bg-white"
          >
            <div class="text-center text-2xl mt-24 mb-2">欢迎使用</div>
