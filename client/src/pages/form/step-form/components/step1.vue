...
<template>
  <div>
    ...
    >
      ...
      >
        <a-select v-model:value="formState.paymentAccount" placeholder="ant-design@alipay.com">
          <a-select-option value="1"> antdv@aibayanyu.com </a-select-option>
        </a-select>
      </a-form-item>
      <a-form-item
        label="收款账户"
      ...
      >
        <a-input v-model:value="formState.collectAccount" />
      </a-form-item>
      <a-form-item
        label="收款人姓名"
        name="name"
